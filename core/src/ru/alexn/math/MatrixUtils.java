...
public class MatrixUtils {
     ...
     */
    public static void calcTransitionMatrix(Matrix4 mat, ru.alexn.math.Rect src, ru.alexn.math.Rect dst) {
     ...
     * @param dst итоговый квадрат
     */
    public static void calcTransitionMatrix(Matrix3 mat, ru.alexn.math.Rect src, ru.alexn.math.Rect dst) {
        float scaleX = dst.getWidth() / src.getWidth();
        float scaleY = dst.getHeight() / src.getHeight();
